...
class BracketsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bracket" do
    assert_difference('Bracket.count') do
      post brackets_url, params: { bracket: { champs: @bracket.champs, runnerup: @bracket.runnerup, semi1: @bracket.semi1, semi2: @bracket.semi2, semi3: @bracket.semi3, semi4: @bracket.semi4 } }
    end
  ...
  test "should update bracket" do
    patch bracket_url(@bracket), params: { bracket: { champs: @bracket.champs, runnerup: @bracket.runnerup, semi1: @bracket.semi1, semi2: @bracket.semi2, semi3: @bracket.semi3, semi4: @bracket.semi4 } }
